...
execute if score %rand.type repo_dummy matches 5 run data modify storage repo:rand type set value "minecraft:parrot"
execute if score %rand.type repo_dummy matches 6 run data modify storage repo:rand type set value "minecraft:panda"
