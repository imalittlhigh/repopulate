...
execute if score %rand.type repo_dummy matches 1 run data modify storage repo:rand type set value "minecraft:turtle"

tellraw @a[tag=repo.debug] [{"text": "Detected Beach","color": "gray"}]
