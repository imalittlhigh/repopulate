...
execute if score %rand.type repo_dummy matches 44..48 run data modify storage repo:rand type set value "minecraft:rabbit"

tellraw @a[tag=repo.debug] [{"text": "Detected Flower Forest","color": "gray"}]
