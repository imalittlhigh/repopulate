...
execute if score %rand.type repo_dummy matches 1 run data modify storage repo:rand type set value "minecraft:polar_bear"
execute if score %rand.type repo_dummy matches 2 run data modify storage repo:rand type set value "minecraft:rabbit"
