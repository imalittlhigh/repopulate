...
execute if score %rand.type repo_dummy matches 1 run data modify storage repo:rand type set value "minecraft:goat"

tellraw @a[tag=repo.debug] [{"text": "Detected Jagged Peaks","color": "gray"}]
