...
execute store result score %rand.type repo_dummy run random value 1..3
...
execute if score %rand.type repo_dummy matches 1 run data modify storage repo:rand type set value "minecraft:rabbit"
execute if score %rand.type repo_dummy matches 2 run data modify storage repo:rand type set value "minecraft:sheep"
execute if score %rand.type repo_dummy matches 3 run data modify storage repo:rand type set value "minecraft:donnkey"
