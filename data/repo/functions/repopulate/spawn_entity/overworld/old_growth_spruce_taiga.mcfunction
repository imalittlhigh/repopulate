...
execute store result score %rand.type repo_dummy run random value 1..7
...
execute if score %rand.type repo_dummy matches 5 run data modify storage repo:rand type set value "minecraft:wolf"
execute if score %rand.type repo_dummy matches 6 run data modify storage repo:rand type set value "minecraft:fox"
execute if score %rand.type repo_dummy matches 7 run data modify storage repo:rand type set value "minecraft:rabbit"
