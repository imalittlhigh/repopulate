...
execute if score %rand.type repo_dummy matches 1..10 run data modify storage repo:rand type set value "minecraft:rabbit"
execute if score %rand.type repo_dummy matches 11 run data modify storage repo:rand type set value "minecraft:polar_bear"
